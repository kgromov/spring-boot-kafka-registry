...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4465627183431592540L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedEvent\",\"namespace\":\"org.kgromov.schema.events\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"long\"},{\"name\":\"food\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
  ...
  private java.lang.CharSequence food;
   ...
   */
  public OrderCreatedEvent(java.lang.Long orderNumber, java.lang.CharSequence food, java.lang.Integer quantity) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: food = (java.lang.CharSequence)value$; break;
   ...
   */
  public java.lang.CharSequence getFood() {
    return food;
  }
   ...
   * @param value the value to set.
   */
  public void setFood(java.lang.CharSequence value) {
    this.food = value;
  }
   ...
   */
  public static org.kgromov.schema.events.OrderCreatedEvent.Builder newBuilder() {
    return new org.kgromov.schema.events.OrderCreatedEvent.Builder();
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static org.kgromov.schema.events.OrderCreatedEvent.Builder newBuilder(org.kgromov.schema.events.OrderCreatedEvent.Builder other) {
    if (other == null) {
      return new org.kgromov.schema.events.OrderCreatedEvent.Builder();
    } else {
      return new org.kgromov.schema.events.OrderCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static org.kgromov.schema.events.OrderCreatedEvent.Builder newBuilder(org.kgromov.schema.events.OrderCreatedEvent other) {
    if (other == null) {
      return new org.kgromov.schema.events.OrderCreatedEvent.Builder();
    } else {
      return new org.kgromov.schema.events.OrderCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.kgromov.schema.events.OrderCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.kgromov.schema.events.OrderCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder setOrderNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder clearOrderNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder setFood(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder clearFood() {
      food = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderCreatedEvent.Builder clearQuantity() {
    ...
    public OrderCreatedEvent build() {
      try {
        ...
        record.food = fieldSetFlags()[1] ? this.food : (java.lang.CharSequence) defaultValue(fields()[1]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.food = in.readString(this.food instanceof Utf8 ? (Utf8)this.food : null);
