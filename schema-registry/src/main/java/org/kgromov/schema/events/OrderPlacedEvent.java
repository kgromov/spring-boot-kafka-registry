...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 874928611886624372L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"org.kgromov.schema.events\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"long\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.Long orderNumber, java.lang.CharSequence email, java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
   ...
   */
  public static org.kgromov.schema.events.OrderPlacedEvent.Builder newBuilder() {
    return new org.kgromov.schema.events.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static org.kgromov.schema.events.OrderPlacedEvent.Builder newBuilder(org.kgromov.schema.events.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new org.kgromov.schema.events.OrderPlacedEvent.Builder();
    } else {
      return new org.kgromov.schema.events.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static org.kgromov.schema.events.OrderPlacedEvent.Builder newBuilder(org.kgromov.schema.events.OrderPlacedEvent other) {
    if (other == null) {
      return new org.kgromov.schema.events.OrderPlacedEvent.Builder();
    } else {
      return new org.kgromov.schema.events.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.kgromov.schema.events.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.kgromov.schema.events.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder setOrderNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder clearOrderNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.kgromov.schema.events.OrderPlacedEvent.Builder clearLastName() {
      lastName = null;
